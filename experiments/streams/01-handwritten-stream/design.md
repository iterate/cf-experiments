...
| Validate append event input before idempotency or durability handling | Malformed runtime events could throw incidental property-access errors or reach later append logic | "rejects malformed append events before idempotency or durability handling" |
