...
import { connectStream, streamRpcPath } from "../../../src/browser/connect.js";
    ...
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      >
        ...
        >
          ...
          <output className="whitespace-nowrap font-mono text-xs text-[#667085]" data-testid="connection-status">
            {status}
          </output>
        </div>
        {error !== undefined ? (
          <p className="border-b border-[#fecdca] bg-[#fff4f2] px-2.5 py-2 text-xs text-[#912018]" data-testid="stream-state-error" role="alert">
            {error}
          </p>
        ) : null}
        <pre
